...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "w-full min-w-0 max-w-full rounded-[18px] border border-border bg-card text-card-foreground shadow-card",
      className
    )}
    {...props}
  />
...
const CardFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("flex items-center p-4 pt-0 md:p-5 md:pt-0 xl:p-6 xl:pt-0", className)} {...props} />
));
